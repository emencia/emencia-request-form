...
import request_form
from request_form.factories.cms import PageFactory
...
class FixturesSettingsTestMixin(object):
    ...
    def __init__(self):
        self.application_path = Path(request_form.__file__).parents[0].resolve()
        self.application_urlpath = "request_form"
    ...
    def format(self, content):
        ...
        return content.format(
            ...
            VERSION=request_form.__version__,
